...
const SubjectsFiles = () => {
  ...
  const files = [
    { name: 'Data science', editTime: 'Edited: 23 Dec, 4 PM' },
    { name: 'Data science', editTime: 'Edited: 23 Dec, 4 PM' },
    { name: 'Data science', editTime: 'Edited: 23 Dec, 4 PM' },
    { name: 'Data science', editTime: 'Edited: 23 Dec, 4 PM' },
    { name: 'Data science', editTime: 'Edited: 23 Dec, 4 PM' },
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-3">
          ...
          <div className="relative">
            ...
            >
             <File className='h-4 w-4'/> <span className="text-sm"> Big Data</span>
        ...
        {files.map((file, index) => (
          ...
          >
            ...
            <div className="pb-4 pt-2">
              ...
              <p className="text-xs text-gray-500">{file.editTime}</p>
            </div>
          </div>
        ))}
      </div>
